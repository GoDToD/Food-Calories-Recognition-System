...
onnx_model = YOLO(r"D:\projects\Food\runs\train\food101_experiment\weights\best.onnx", task="detect")
...
results = onnx_model.predict(r'D:\projects\Food\data\images\train\chicken_wings_3282233.jpg', imgsz=(320, 320))
